...
# 索引顺序: 郑0 州1 轻2 工3 业4 大5 学6 前7 进8 后9 退10 停11 止12 左13 转14 右15 张16 毅17
from PIL import Image, ImageDraw, ImageFont

chars = "郑州轻工业大学前进后退停止左转右张毅"
...
lines.append("// 索引: 郑0 州1 轻2 工3 业4 大5 学6 前7 进8 后9 退10 停11 止12 左13 转14 右15 张16 毅17")
lines.append("static const uint8_t HZ_LIB[18][32] = {")
for ch in chars:
    # 先画到大图再缩放到 16x16
