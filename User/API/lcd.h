...
// ============================================================
// 图片/动图功能开关
// 默认关闭：不把 lcd_img.h / lcd_anim.h 的位图数据(约160KB+)编入固件，
//           可显著减小固件体积、加快烧录。需要显示预存图片/动图时，
//           取消下面一行注释后重新编译即可（代码与数据文件均保留）。
// #define ENABLE_ANIM   // 关闭图片/动图功能：不编入 lcd_img.h(141KB)/lcd_anim.h(564KB)，固件更小、烧录更快（STM32F103RC Flash 仅256KB，开此宏会超限）
// ============================================================
